...
const SearchCity = () => {
  ...
  const [searchResults, setSearchResults] = useState<CityWeather>(defaultCityWeather);
  ...
  return (
    <>
      {/*<Box fill align="center" justify="center" pad="large" width="large">*/}
        <div className="container" >
          <div className="TextInput">
            ...
            <span
              onClick={onClick}>
              <p className="City"> City: {searchResults?.name} </p>
            </span>
          </div>
